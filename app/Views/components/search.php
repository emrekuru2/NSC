 ...
 *
 * Optional:
 * @param boolean $useName <p>Use name in search bar title. E.g., true = 'Search Teams', false = 'Search'.</p>
 */
?>
            ...
            <tr>
                <td class="col-11 border-style-none">
                    <div class="autocomplete">
                        <input class="form-control" type="text" id="search" name="search" placeholder="Type to search <?= strtolower($name); ?>...">
                    </div>
                </td>
            </tr>
        </tbody>
...
<script>
    let array = ['Falcons', 'Lions', 'Lemurs', 'Tigers', 'Test Team', 'Certified Bruh Moments']
</script>
