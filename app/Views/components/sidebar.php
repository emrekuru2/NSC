        ...
        <li class="nav-item">
          <div class="accordion accordion-flush" id="competitionsDrop">
            <div class="accordion-item">
              ...
              <div id="collapseCompetitions" class="accordion-collapse collapse" data-bs-parent="#competitionsDrop">
                <div class="accordion-body p-2">
                  ...
                  <a href="<?= base_url('admin/CompetitionType') ?>" class="nav-link link-primary text-light <?= ($title === 'Competition Types') ? 'active' : '' ?>"><i class="fa-solid fa-flask fa-lg me-3 fa-fw"></i>Competition Types</a>
                </div>
              </div>
            </div>
        </li>
        ...
        <li class="nav-item">
          <div class="accordion accordion-flush" id="developmentsDrop">
            <div class="accordion-item">
              ...
              <div id="collapseDevelopments" class="accordion-collapse collapse" data-bs-parent="#developmentsDrop">
                <div class="accordion-body p-2">
                  <a href="<?= base_url('admin/development') ?>" class="nav-link link-primary text-light <?= ($title === 'Developments') ? 'active' : '' ?>"><i class="fa-solid fa-book fa-lg me-3 fa-fw"></i>Development</a>
                  <a href="<?= base_url('admin/developmentTypes') ?>" class="nav-link link-primary text-light <?= ($title === 'Development Types') ? 'active' : '' ?>"><i class="fa-solid fa-flask fa-lg me-3 fa-fw"></i>Development Types</a>
                </div>
              </div>
            </div>
        </li>
