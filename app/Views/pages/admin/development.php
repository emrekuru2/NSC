        ...
        <div class="row-lg">
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <?= view_cell('\App\Libraries\Contents::search', ['route' => 'modify_development', 'name' => 'Develop Program', 'array' => $programs, 'fields' => ['name'], 'method' =>  'post', 'useName' => true, 'useDivider' => true]) ?>
