        ...
        <div class="col-lg-8">
            <div class="card h-100 shadow">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" style="width: 20%;" id="YearRunning">YearRunning</span>
                        <input type="text" class="form-control" name="yearRunning" placeholder="YearRunning" aria-label="yearRunning" aria-describedby="email">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" style="width: 20%;" id="cT">Competition Type</span>
                        <input type="text" class="form-control" name="competitionType" placeholder="CompetitionType" aria-label="competitionType" aria-describedby="fb">
                    </div>
