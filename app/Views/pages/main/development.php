  ...
  <section class="dark-grey-text text-center">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-4">
        ...
        <img src="<?= base_url('assets/images/Dev/default.png') ?>" class="img-thumbnail rounded"
          style="width: 235px; height: 235px;">
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mb-3"><?= esc($program->name) ?></h4>
          <button type="button" class="btn btn-primary view-program" data-bs-toggle="modal"
            data-bs-target="<?= '#' . $program->id ?>">View</button>
        </div>
      </div>
      <!-- Grid column -->
      <?= view_cell('\App\Libraries\Contents::mainDevelopmentModal', [
    'program' => $program,
    'id' => $program->id,
]) ?>
      <?php endforeach; ?>
