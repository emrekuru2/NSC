...
<!-- The New Section -->
                ...
                <div class="card mb-3 mx-5" style="width: 20rem;">
                    <div class="card-body d-flex flex-column">
                        <div class="text-center mb-3">
                            <h4 class="card-title"><?= esc($news_item->title) ?></h4>
                        </div>
                        <p class="card-text overflow-auto" style="max-height: 12rem; max-width: 100%;"><?= esc($news_item->content) ?></p>
    ...
    <div class="container d-flex flex-wrap justify-content-between py-5">
        ...
        <div class="col-lg-5 col-md-12 mb-5">
            <div class="card h-100" style="background-color: blue;">
                <div class="card-body">
