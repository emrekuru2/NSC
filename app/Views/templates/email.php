                                ...
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left" bgcolor="#ffffff">
                                        ...
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <div style="display: flex; justify-content: center;">
                                              <img style="height: 100px; width: 100px; display: inline; line-height: 100%; outline: none; text-decoration: none; border-style: none; border-width: 0;" src="https://scontent-yyz1-1.xx.fbcdn.net/v/t39.30808-6/308744572_483437700490257_8210535769749177538_n.jpg?_nc_cat=111&amp;ccb=1-7&amp;_nc_sid=09cbfe&amp;_nc_ohc=-BxD2-b5MSYAX8at_0G&amp;_nc_ht=scontent-yyz1-1.xx&amp;oh=00_AfAXPIjX-llWMkTy-HrdNihqHvygci-P4r7XHfkasuMt7Q&amp;oe=6439F6DB">
                                            </div>
                                            ...
                                            <h1 class="h3  text-center" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center"><?= $subject ?></h1>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-gray-700 text-center" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="center"><?= $message ?></p>
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
                                    ...
                                    <div class="text-muted text-center" style="color: #718096;" align="center">
                                      Cricket Nova Scotia Association <br>
                                    </div>
                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        <tr>
